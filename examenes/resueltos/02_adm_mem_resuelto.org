...
4. Un equipo está presentando rendimiento muy deficiente. Un análisis
   ...
   *Respuesta:*
   ...
   efectivas serían: Benéficas, /d/, /e/ y /f/; prácticamente
   indiferentes, /a/, /b/; dañina, /c/ (y calificaré commo correctas a
   /d/, /e/ y /f/, aunque el impacto de /f/ sea relativamente menor)
