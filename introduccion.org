...
Esquematización de la arquitectura básica de los sistemas monolíticos,
microkernel e híbridos. ([[https://commons.wikimedia.org/wiki/File:OS-structure2.svg][Imagen de la Wikipedia]])
#+end_center
...
| Nivel                   | 1                                    | 2                                | 3                 | 4                 |
|-------------------------+--------------------------------------+----------------------------------+-------------------+-------------------|
| *Nombre*                | Registros                            | Cache                            | Memoria principal | Disco             |
| *Tamaño típico*         | <1KB                                 | <16MB                            | <64GB             | >100GB            |
| *Tecnología típica*     | Memoria específica multipuerto, CMOS | RAM estática CMOS (en chip o no) | CMOS DRAM         | Disco magnético   |
| *Tiempo de acceso (ns)* | 0.25-0.5                             | 0.5-25                           | 80-250            | 5,000,000         |
| *Ancho de banda (MB/s)* | 20,000-100,000                       | 5,000-10,000                     | 1,000-5,000       | 20-150            |
| *Administrado por*      | Compilador                           | Hardware                         | Sistema operativo | Sistema operativo |
| *Respaldado en*         | Cache                                | Memoria principal                | Disco             | CD o cinta        |


Velocidad y gestor de los principales niveles de
memoria. (Silberschatz, Galvin, Gagne; p.28)
#+end_center
...
Un API expone una interfaz en un lenguaje de alto nivel hacia una
llamada al sistema. (Imagen: /Operating System Concepts Essentials/;
Silberschatz, Galvin, Gagne; p.56)
#+end_center
