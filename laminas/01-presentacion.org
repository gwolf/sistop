...
- Repositorio :: \small https://github.com/unamfi/sistop-2022-1/

** Horario, calendario
- Martes y jueves
- 17:30 (*no 17:45*, aunque hay tolerancia) a 19:45
- +Salón+ Videoconferencia en https://clase.sistop.unam.mx/sistop-2022-1
- 72 horas clase en total
  - Según el plan 2010; el plan 2016 contempla sólo 64 horas
  - Trabajaremos la sesion de 02:15 /completa/
  - /Perdemos/ una semana efectiva por el ajuste del calendario, y el
    2 de noviembre es feriado $\rightarrow$ *65:15 horas* /efectivas/.
...
#+BEGIN_CENTER
[[http://github.com/unamfi/sistop-2022-1]]
#+END_CENTER
...
#+END_CENTER
- +Al martes inmediato siguiente a su aplicación+ (...¡es difícil
  comprometer tiempos en esta época de confinamiento!)
...
#   calificarlos.
- Examenes finales /orales/. Guardaré copia del video por si tienen
...
- Las exposiciones buscarán deben buscar anclar la teoría que estamos
...
- +Expondrán sus proyectos ante el grupo+ Presentarán a sus alumnos
  videos exponiendo sus temas
...
- Repositorio :: \small https://github.com/unamfi/sistop-2020-2/
