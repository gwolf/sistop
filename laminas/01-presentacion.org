...
- Repositorio :: \small https://github.com/unamfi/sistop-2026-2/

** Horario, calendario
- Martes y jueves
- 17:00 a 19:00
- Videoconferencia en
    https://salon.sistop.unam.mx/sistop-2026-2
- 64 horas clase en total
  - Pero /perdimos/ una semana de clases por el... /asuntito/ de las
    inscripciones :-\
  - Y el martes 15 de septiembre es feriado
  - ...Además, participaré en un congreso en la semana del 12 al 16 de
    octubre en =GMT+3=
  - $\Rightarrow$ *54 horas efectivas* de clase
    - Tengo pendiente aún ver cómo /cubrir mejor/ mi ausencia, podría ser
      un poquito más)
    # - Pero tendremos feriado el martes 16 de septiembre
    # - Y el jueves 18 de septiembre (y probablemente 6 de noviembre)
    #   participaré en congresos...
    # - $\Rightarrow$ *58 horas efectivas* de clase
...
[[../img/pres/diseño_electronico.jpg]]

#+attr_latex: :width \textwidth
[[../img/pres/object_oriented_programming.jpg]]
...
#+latex: \vskip 3em \tiny \raggedleft
Generadas por /perchance.org/
...
[[../img/syscall.jpg]]
#+latex: \tiny \raggedleft
Generada por /perchance.org/
...
#+attr_latex: :width \textwidth
[[../img/pres/librero1.jpg]]
#+attr_latex: :width \textwidth
[[../img/pres/librero2.jpg]]
#+latex: \end{column} \end{columns}
...
#+latex: \tikzoverlay[text width=1cm] at (9cm,8cm) { \includegraphics[width=\textwidth]{../img/pres/gwolf_hackergotchi.png} };
...
#+latex: \tikzoverlay[text width=1cm] at (4cm,7.5cm) { \includegraphics[width=\textwidth]{../img/pres/gwolf_hackergotchi.png} };

** ¿Qué espero que logremos?

#+begin_export latex
\tikzoverlay[text width=1cm] at (0cm,1cm) { \includegraphics[width=\textwidth]{../img/pres/gwolf_hackergotchi_r.png} };
...
#+latex: \tikzoverlay[text width=1cm] at (0cm,0.5cm) { \includegraphics[width=\textwidth]{../img/pres/gwolf_hackergotchi_45.png} };
...
\url{http://github.com/unamfi/sistop-2027-1}
...
- ¿Trabajo de investigación? ¡Evítense problemas! Nada de /copiar y
  pegar/.
  - Exposiciones y proyectos, /pueden ser/ verificadas por /Compilatio.net/
    buscando similitudes y (ab)uso de LLMs.
#+latex: \end{column} \end{columns}
