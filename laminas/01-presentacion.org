...
- 72 horas clase en total… En teoría.
  - Este semestre "perdemos" 15 de septiembre y 1 de noviembre
  - 2 o 3 clases para exposición de temas por parte de invitados
- La evaluación principal será con dos trabajos prácticos y un examen
  parcial (detalles más adelante)

* Encuadre del curso

** El curso dentro de la currícula de la carrera, plan 2010
#+begin_center
...
Remzi H. Arpaci-Dusseau y Andrea C. Arpaci-Dusseau \\ University of
 Wisconsin Madison \\ Disponible en
 línea desde [[http://pages.cs.wisc.edu/~remzi/OSTEP][el sitio Web del autor]] capítulo por capítulo, y a la
 venta tanto [[http://pages.cs.wisc.edu/~remzi/OSTEP/book-softcover.html][impreso]] como [[http://pages.cs.wisc.edu/~remzi/OSTEP/book-electronic.html][en un sólo PDF]].
...
** Uso de la plataforma de cursos

- En el transcurso del curso emplearemos la plataforma educativa
  /Moodle/ que administro:
  #+latex: \url{http://docencia.iiec.unam.mx/course/view.php?id=11}
- Para darlos de alta, requiero el correo electrónico de todos los
  alumnos

** Depósito en GitHub
#+BEGIN_CENTER
Este semestre introduzco un /experimento/
#+END_CENTER
...
- ...Probablemente tengamos que ir afinándolo en el transcurso del
  curso
#+BEGIN_CENTER
http://github.com/gwolf/clase-sistop-2017-01
#+END_CENTER
...
- Desarrollo /propio y original/ que integre el contenido visto en
  ...
  - Administración / planificación de procesos :: Que efectúen
       monitoreo o configuración del sistema operativo de su
       preferencia, en un programa multihilos y empleando
       sincronización.
  - Sistemas de archivos :: Desarrollo de un micro-sistema de archivos
- La fecha de entrega será anunciada con por lo menos una semana de
  antelación (aproximado: Fines de septiembre y mediados de noviembre)
...
- La fecha será anunciada con por lo menos una semana de antelación
  (previsto: mediados a fines de octubre)
...
- La entrega de tareas es /obligatoria/
  ...
  - Más de tres semanas de demora: Calificada como 0, no se recibe ya
