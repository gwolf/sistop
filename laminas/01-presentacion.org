...
- 72 horas clase en total… En teoría.
  - Este semestre "perdemos" el 16 de septiembre
  - 2 o 3 clases para exposición de temas por parte de invitados
- Este semestre intentaré evaluar más basado en trabajos prácticos (no
  con exámenes parciales)
  - ...¡Iremos viendo cómo nos resulta!
...
- Agrupando unidades relacionadas, les pediré algunos proyectos de
  desarrollo a lo largo del curso
  - Desarrollo /propio y original/ que integre el contenido visto
  - Que efectúen monitoreo o configuración del sistema operativo de su
    preferencia.
