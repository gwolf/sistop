...
#+TITLE: Sistemas Operativos (FI-UNAM 1554 / 0840): Presentación del curso
#+DATE:
...
- 72 horas clase en total
  - Según el plan 2010; el plan 2016 contempla sólo 64 horas
  - Trabajaremos la sesion de 02:15 /completa/
- La evaluación principal será con trabajos prácticos
- Mas un examen parcial (detalles más adelante)
...
[[../img/pres/mapa_curricular_2010.png]]
#+end_center

** El curso dentro de la currícula (plan 2016)
#+begin_center
#+attr_latex: :height 0.85\textheight
...
- Asumo familiaridad con otras materias:
  - 2010 :: 
    ...
    - Programación avanzada y métodos numéricos \vskip 1em
  - 2016 :: 
    - Fundamentos de programación
    - Programación orientada a objetos \vskip 1em
  - Ambos ::
...
[[../img/pres/prog_estudio_2010.png]]
#+end_center
...
- ...Probablemente tengamos que ir afinándolo en a lo largo del curso
#+BEGIN_CENTER
[[http://github.com/gwolf/sistop-2019-2]]
#+END_CENTER
