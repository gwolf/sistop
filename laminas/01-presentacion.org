...
- 72 horas clase en total… En teoría.
  - Este semestre "perdemos" el 10 de mayo
...
- Los encontrarán con frecuencia en su fica diaria/futura
- Pero para aprender...
#+latex: \pause
#+BEGIN_CENTER
¡Tarea!
...
- Requiero que /todos los alumnos/ se den de alta en el curso.
- Siempre que no haya instrucción explícita en otro sentido, /las
  tareas se entregan por esa vía/.
...
- La fecha de entrega será anunciada con por lo menos una semana de
  antelación (previsto: Antes de vacaciones de Semana Santa y hacia la
...
- La fecha será anunciada con por lo menos una semana de antelación
  (previsto: mediados a fines de abril)
