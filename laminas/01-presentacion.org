...
[[../img/pres/mapa_curricular_2023.png]]
...
#+begin_export latex
  { \centering \scriptsize Adicionalmente al objetivo formal... }
   ...
   \begin{columns}
     ...
     \includegraphics[width=0.9\textwidth]{../img/pres/computo_maya.png}
     \end{column}
   ...
   \begin{columns}
     ...
     \includegraphics[width=\textwidth]{../img/pres/foco_feliz.png}
     \end{column}
   \end{columns}
   \pause
   ...
   \begin{columns}
     ...
     \includegraphics[width=\textwidth]{../img/pres/herramientas.png}
     \end{column}
