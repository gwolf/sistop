...
#+DATE: 2013-08-08 — 2013-08-13

* Objetivo
** Objetivo de la sesión
- Presentar y definir el concepto de /sistemas operativos/
- Hacer un repaso histórico de 50 años del desarrollo del cómputo,
  en lo relativo al desarrollo de los sistemas operativos
  - De donde se desprenderán conceptos y estructuras básicos que
...
- ¿Qué definimos como sistema operativo? (y qué no)
  - Abstracción/embellecimiento
  - Gestión de recursos
  - Aislamiento y protección
- Sistemas operativos históricos
  ...
  - Multiprogramación
  - Tiempo compartido
  - Microcomputadoras (evolución principalmente \approx 1975 — 1990)
** En esta presentación vimos...
- Tipos de multitarea
  - /Cooperativa/ o /no apropiativa/
  - /Preventiva/ o /apropiativa/
- Ejecución en /espacio núcleo/ y /espacio de usuario/
- Tipos fundamentales de organización de sistema operativo
  - Monolítico
  - Microkernel
  - Híbrido
