...
#+caption: La /meditación del gurú/: Error de acceso a memoria... tristemente frecuente
...
- Fines de los 1980 — Intel 80486, Motorola 68040, PowerPC: Hardware
  ...
  - Economías de escala: Por una fracción del precio
...
#+latex: \end{column} \begin{column}{0.5\textwidth}
#+latex: \only<1>{
#+latex: {\centering \textbf{¿Dispositivos móviles?} }

- ¿Es lo mismo que decir /dispositivos más pequeños/?
- ¿Qué otras características debemos desarrollar?
#+latex: } \only<2>{
#+attr_latex: :width 0.9\textwidth
[[./hp-01.jpg]]
#+latex: { \,\hfill \tiny \textcolor{gray}{img:} CC BY-SA \, \textcolor{gray}{Wikipedia: HP-01 (1977)} }
#+latex: } \end{column} \end{columns}
...
#+latex: \only<1>{
- Equipos limitados en rendimiento
#+latex: } \only<2>{
- +Equipos limitados en rendimiento+ ¿En serio?
#+latex: }
