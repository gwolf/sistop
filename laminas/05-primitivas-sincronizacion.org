...
- Hay tres fumadores compulsivos / en cadena
  - Cada uno tiene una cantidad ilimitada de /uno/ de los
    ingredientes
...
- Código resultante /más complejo/ (más elementos a considerar),
  aunque más flexible
  - Ejemplo de complejidad: No funcionó tras un tiempo razonable :-P
  - Podría mejorarse con un poco de /azucar sintáctico/
- Menor acoplamiento entre funciones
