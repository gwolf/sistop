...
** Objetivo de esta sección (1)
#+BEGIN_CENTER
En esta sección nos concentraremos en aprender los siguientes
conceptos:
#+END_CENTER
- Programas, procesos, tareas, hilos
  - ¿Qué son? ¿En qué se parecen? ¿Cuál es su diferencia?
  - ¿En qué estados pueden estar? ¿Cómo cambian de uno a otro?
  - ¿Qué implica un /cambio de contexto/?
  - ¿Cómo estructuramos a nuestro programa para emplear varios
    hilos o procesos?
  - ¿Cómo comprende y maneja el sistema operativo a los diferentes
    tipos de hilos?

** Objetivo de esta sección (2)
- Qué significa la /concurrencia/. Algunos conceptos:
  - Exclusión mutua
  - Bloqueos mutuos
  - Inanición
- Planteamiento de cuatro problemas clásicos de sincronización
