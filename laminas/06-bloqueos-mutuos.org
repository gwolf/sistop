...
#+end_center
1. Los procesos reclaman acceso exclusivo de los recursos
   - Condición de /exclusión mutua/
2. Los procesos mantienen los recursos que ya les habían sido
   asignados mientras esperan recursos adicionales
   - Condición de /espera por/
3. Los recursos no pueden ser extraídos de los procesos que los tienen
   hasta su completa utilización
   - Condición de /no apropiatividad/
4. Existe una cadena circular de procesos en que cada uno mantiene a
   uno o más recursos que son requeridos por el siguiente en la cadena
...
- Liberales :: Buscan a otorgar los recursos lo antes posible cuando
	       son solicitados
- Conservadiras :: Controlan más el proceso de asignación de recursos
