...
#+DATE: 2013-08-29 — 2013-09-??

* Introducción a la concurrencia
** Objetivos de esta presentación (1)
- Comprender los problemas que derivan de la ejecución concurrente
  - Particularmente sobre datos /compartidos/
- Familiarizarse con los principales conceptos con que trabajaremos en este tema
...
- Comprender las principales /primitivas de sincronización/
  - ¿Por qué tienen que ser /primitivas/?
  - /Mutex/ (Exclusión mutua)
  - Semáforos
  - Variables condicionales
  - Monitores
- Conocer algunas soluciones en hardware propuestas para estos
  problemas

** Objetivos de esta presentación (3)
- Breviario: ¿Patrones de programación? ¿Qué son? ¿De qué me sirven?
- Conocer y comprender los principales patrones de sincronización
  entre procesos
  - Estudiando su implementación basada en semáforos
- Comprender la aplicación de los patrones a problemas reales
  - Abordando cuatro de problemas clásicos de sincronización
...
- /Mayor acoplamiento/ entre las tres funciones
  ...
  - Cada función debe /comprender/ su rol en la /línea de ensamblaje/
...
- Ventaja :: Menor acoplamiento entre funciones
  ...
  - Podría configurarse en un sólo punto, p.ej:
#+BEGIN_SRC ruby
def initialize
...
- Habrán notado que el comentario al código basado en CV menciona que
...
- ¿Cómo puede el intérprete /prevenir/ este bloqueo y /notificar al
  programador/?
