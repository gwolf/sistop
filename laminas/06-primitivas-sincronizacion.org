...
- *Error de programación* (sí, siempre)
- Implica a dos procesos (o hilos)
- Fallan al comunicarse su /estado mutuo/
  - Al manejar algún /recurso compartido/ (variables, archivos, dispositivos,
    ...)
...
- Requiere /ser protegida de accesos concurrentes/
...
- Espera activa (/spinlock/): Desperdicio de recursos
  ...
  - En un sistema multiprocesador, afecta al sistema completo \faFrown
...
- Mutexes a través de la declaración =synchronized=
  - A nivel bloques de código, métodos de instancia y métodos estáticos
- /Variables de condición/
...
- Inhabilita el multiproceso preventivo
  - Demasiado peligroso \rarrow Bastaría un error en la sección
    ...
    entero
- Y hay /Interrupciones no enmascarables/...
...
- Garantiza que un grupo de hilos o procesos pasan por un punto
  ...
  - Permite /controlar fácilmente/ si pasan o se detienen
  - No sirve de mucho /por sí sólo/
...
** Barrera
- Permite el paso cuando se hayan juntado /n/ hilos/procesos listos,
  no antes
...
#+caption: Imagen generada: perchance.org
[[../img/apagador.jpg]]
...
- Metáfora empleada:
  ...
  - Los procesos que quieren entrar deben verificar /si está prendida
    la luz/
- O consideren también...
  - Las avenidas que cambian de sentido según el horario de máximo
    flujo
...
#+attr_latex: :width \textwidth
#+caption: Imagen generada: perchance.org
[[../img/productor-consumidor.jpg]]
#+latex: \end{column} \end{columns}

** Problema productor-consumidor: Refinamientos posibles...
...
#+latex: \end{column} \begin{column}{0.4\textwidth}
#+attr_latex:  :width \textwidth
[[../img/lectores-escritores.jpg]]
#+attr_latex:  :width \textwidth
#+caption: Imágenes generada: perchance.org
[[../img/lectores-escritores.2.jpg]]
#+latex: \end{column}\end{columns}
...
#+BEGIN_CENTER
#+attr_latex: :width 0.5\textwidth
[[../img/filosofo_arroz.jpg]]
#+END_CENTER
#+latex: {\scriptsize Imagen: Perchance.org}
...
- Gingras propone un algoritmo libre de inanición, pero demanda de
  ...
  original
#+BEGIN_CENTER
[[https://dl.acm.org/citation.cfm?id%3D101091][Artículo de Gingras (1990): /Dining philosophers revisited/]]
#+END_CENTER
