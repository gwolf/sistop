...
- Recordemos que =pthreads= permite, en muchos casos, responder al
  proceso /«Disculpa, no puedo hacer eso»/
...
- Un procesador moderno presenta mucho más etapas (Pentium 4: 20
  etapas)
