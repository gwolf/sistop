...
#+caption: Two trains crossing each other at India's Famous Diamond Crossing (youtube.com)
[[../img/two_trains_crossing.png]]
...
#+begin_center
*Asumimos*:
- Un sistema tiene dos unidades de cinta (acceso secuencial, no-compartible)
- El acceso a las cintas se protege con un /mutex/.
...
- El papel del sistema operativo va más allá de lo presentado en las
...
#+caption: Generada (perchance.org)
[[../img/advance_claim.jpg]]
#+latex: \end{column} \begin{column}{0.5\textwidth}
...
#+attr_latex: :width 0.5\textwidth
#+caption: \small OpenEdition Journals: Intervención norteamericana, 1914. Daniel Escorza Rodríguez.
[[../img/matalos_en_caliente.jpg]]


** Retroceder al último /punto de control/ (/checkpoint/)
#+latex: \begin{columns} \begin{column}{0.35\textwidth}
#+attr_latex: :width \textwidth
#+caption: Yoshi's Wooly World Checkpoint, Super Mario Wiki
[[../img/yoshi_checkpoint.jpg]]
...
#+attr_latex: :width \textwidth
#+caption: \scriptsize Avestruz (\href{https://es.wikipedia.org/wiki/Archivo:Avestruz_(Struthio_camelus),_Zoo_de_Ciudad_Ho_Chi_Minh,_Vietnam,_2013-08-14,_DD_01.JPG}{Wikipedia} CC BY-SA)
[[../img/avestruz.jpg]]
...
#+latex: \begin{columns} \begin{column}{0.8\textwidth}
...
#+latex: \end{column} \begin{column}{0.2\textwidth}
#+attr_latex: :width \textwidth
#+caption: \scriptsize Avestruz (\href{https://es.wikipedia.org/wiki/Archivo:Avestruz_(Struthio_camelus),_Zoo_de_Ciudad_Ho_Chi_Minh,_Vietnam,_2013-08-14,_DD_01.JPG}{Wikipedia} CC BY-SA)
[[../img/avestruz_izq.jpg]]
#+latex: \end{column} \end{columns}
...
[[../img/avestruz_centro_de_datos.jpg]]
#+latex: \end{column} \end{columns}
