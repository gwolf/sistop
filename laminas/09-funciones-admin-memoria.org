...
- Cuando se produce una /falla de caché/ (no tiene copia de la
  ...
  - Insertando =NOOP= \rarrow /stall/ (detención)
...
#+end_center
- Solicita acceso a $direcc < 504214$ \rarrow *Falla:*
  - Violación de segmento (/segmentation fault/)
- Solicita acceso a $504214 < direcc < 569749$ \rarrow *OK*
  - Se otorga acceso a la dirección
- Solicita acceso a $569749 < direcc$ \rarrow *Falla:*
  - Violación de segmento (/segmentation fault/)
...
#+include fig/proceso_en_memoria.png
