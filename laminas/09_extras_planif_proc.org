...
- Finkel apunta a que una /verdadera/ comparación debería ser
  ...
  - Pero presentan ya un acercamiento útil acerca de su comportamiento
    general
#+latex: \end{column} \begin{column}{0.3\textwidth} \, \vskip 4em
#+attr_latex: :width \textwidth
#+caption: Stopwatch (CC BY-SA \url{https://pngimg.com/download/87623})
[[../img/stopwatch.png]]
...
\centering Estrategia empleada por Control Data (CDC6600, 1964, diseñada
por Seymour Cray): *Multitarea gestionada en hardware*
#+latex: \begin{columns} \begin{column}{0.7\textwidth}
...
#+attr_latex: :width \textwidth
#+caption: CDC6600; Computer Museum; Wikimedia Commons CC BY-SA
[[../img/CDC6600.jpg]]
#+latex: \end{column} \end{columns}
...
#+attr_latex: :width \textwidth
#+caption: Balanza y Cronómetro de Kodak (\href{https://www.flickr.com/photos/coleccionandocamaras/5585819540/}{Flickr}, CC BY-NC-ND)
[[../img/balanza.jpg]]
#+latex: \end{column} \end{columns}
...
#+attr_latex: :width 0.25\textwidth
#+caption: Push icon (game-icons.net CC BY)
[[../img/push.png]]
...
#+latex:\end{column}\begin{column}{0.4\textwidth}
Un procesador “moderno” presenta mucho más etapas.

(Pentium 4: 20 etapas, antes de la irrupción de los CPUs multi-core)
#+latex:\end{column}\end{columns}
#+BEGIN_CENTER
#+latex:\scriptsize
...
\centering Nos hemos enfocado a repartir el tiempo disponible entre varios
procesos, pero...
#+latex: \begin{columns} \begin{column}{0.6\textwidth}
...
#+latex: \end{column} \begin{column}{0.4\textwidth}
#+attr_latex: :width \textwidth
#+caption: Train departures board (\href{https://www.flickr.com/photos/dgeezer/39872309300}{Diamond Geezer, Flickr} CC BY-NC-ND)
[[../img/train_board.jpg]]
#+latex: \end{column} \end{columns}

** ¿Cuándo nos enfrentamos con el tiempo real?
- Controladores de dispositivos de audio, red, almacenamiento...
...
- Aplicaciones industriales (robótica; automotriz)
...
#+latex: \end{column} \begin{column}{0.4\textwidth}
#+attr_latex: :width \textwidth
#+caption: Train Station Clock; Bongkarn Thanyakij, Vecteezy, Free License
[[../img/station_clock.jpg]]
#+latex: \end{column} \end{columns}
...
- Un proceso $A$ de baja prioridad hace una llamada al sistema
  - Queda en espera...
- Un proceso $B$ de prioridad /tiempo real/ hace /otra/ llamada al sistema
  - Requiriendo del mismo subsistema que el que bloquea a $A$
- *$B$ quedará esperando hasta que $A$ vuelva a ser agendado*
#+BEGIN_CENTER
Esto es, $B$ fue, para propósitos prácticos, *degradado* a la prioridad de
$A$
#+END_CENTER

** Inversión de prioridades: Mars Pathfinder / Sojourner (1997)
#+latex: \begin{columns} \begin{column}{0.6\textwidth}
\small
- Rover autónomo *Sojourner*
- Sistema operativo: RTOS VxWorks
  - Planificación por prioridades fijas
  - Mutex para recursos compartidos
- Reinicios repetidos y espontáneos
- Bitácora: ~Data bus reset detected~
#+attr_latex: :width 0.7\textwidth
#+caption: \href{https://commons.wikimedia.org/wiki/File:Pathfinder01.jpg}{Pathfinder01} (Wikimedia Commons, PD)
[[../img/Pathfinder01.jpg]]
#+latex: \end{column} \begin{column}{0.4\textwidth}
\small
- *B* (baja prio) toma mutex del bus
- *A* (alta prio) requiere el mutex
- Planificador elige a *C* (med prio)
  - *B* en espera
  - *A* bloqueado...
- Monitoreo detecta que *A* no avanza
  - Reinicio completo del sistema... A 200 millones de kilómetros...
#+latex: \end{column} \end{columns}
...
#+attr_latex: :width \textwidth
#+caption: \href{https://en.wikipedia.org/wiki/File:Sojourner_on_Mars_PIA01122.jpg}{Sojourner on Mars} (Wikimedia Commons, PD)
[[../img/sojourner.jpg]]
#+latex: \end{column} \begin{column}{0.6\textwidth}
- Esta corrección /ya estaba disponible/ (no activa) en VxWorks
  - Logró activarse a distancia, parchando un sistema /en producción/, a
    200 millones de kilómetros
- Salvó la misión. Pathfinder operó por 83 días
  - 3 veces su tiempo de vida previsto.
#+latex: \end{column} \end{columns}
