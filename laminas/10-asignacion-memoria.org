...
#+include: fig/mem_particiones_fijas.ditaa
...
#+include: fig/mem_fragmentacion_con_particiones_flexibles.ditaa
...
** [#B] La tabla de páginas (/page table/)
...
#+include: fig/traduccion_pentium.ditaa
