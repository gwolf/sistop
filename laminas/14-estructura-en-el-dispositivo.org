...
|  0       8        F |     |cRED+-->0x30
|  +-------+--------+ |     +----+
| 3|cRED 08|cRED 20 | |     |cBLU+-->0x40
|  +-------+--------+ |     +----+
| 4|cBLU 28|cYEL 30 | |     |cYEL+-->0x48
|  +-------+--------+ |     +----+
| 5|cRED FF|cBLU 48 | |     |cGRE+-->0x78
|  +-------+--------+ |     +----+
| 6|cYEL FF|cFFF 00 | |
|  +-------+--------+ |
| 7|cGRE FF|cBLU FF | |
...
- Empleando triple indirección, hasta $(100-3 + 128 + (128
  \times 128) + (128 \times 128 \times 128) ) \times 2KB = 4227522KB
  \approx 4GB$
