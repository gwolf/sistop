...
#+begin_src dot :exports results :file ltxpng/fs_journaling.png
  digraph G {
          ...
          ultimaop [label = "Última operación", shape="box", color="pink", style="filled"];
          ultimaop -> 5 [style="dotted"];
          cabeza [label = "Siguiente entrada", shape="box", color="green", style="filled"];
          cabeza -> 3 [style="dotted"];
  }
#+end_src
