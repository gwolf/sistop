...
- /Arreglo Redundante de Discos Independientes/ (/Redundant Array of
  Independent Disks/)
  - Originalmente: De discos /Baratos/ (/Inexpensive/)
...
- Reducción en velocidad (todas las unidades deben leer el sector y
  recalcular el resultado)
- Soporta la pérdida de dos discos
  - El disco de paridad es otro /a cada bloque/
#+attr_latex: width=0.6\textwidth
...
#+begin_src dot :exports results :file ltxpng/raid_6.png
  digraph G {
          ...
          subgraph cluster0 {
                   ...
                   2 [label = "Disco\n2: 1TB", shape="circle"];
                   3 [label = "Disco\n3: 1TB", shape="circle"];
                   4 [label = "Disco\n4: 1TB", shape="circle", color="green"];
                   5 [label = "Disco\n5: 1TB", shape="circle", color="blue"];
                   1 -> 2 [label = "+"];
                   2 -> 3 [label = "+"];
...
** Combinando niveles de RAID
- Ojo: Comparación con RAID 0+1
  - Espejo de unidades concatenadas
- RAID 1+0: Tolera la pérdida de cualquiera de los discos de
  cualquiera de los espejos
- RAID 0+1: Tolera la pérdida de cualquiera de los discos dentro de un mismo espejo
