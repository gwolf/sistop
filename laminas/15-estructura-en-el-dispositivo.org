...
#+caption: Medios de almacenamiento (elab. propia)
[[../img/medios_de_almacenamiento.jpg]]
...
\vskip 2em
#+attr_latex: :width 0.5 \textwidth
#+caption: \scriptsize Generada (perchance.org)
[[../img/hdd_sketch.jpg]]
...
\vskip 2em
#+attr_latex: :width 0.5\textwidth
#+caption: \scriptsize \href{https://www.flickr.com/photos/sararah/2516885650/in/photostream/}{Day 136 - So organized? Sarah Cady, Flickr} CC BY-SA-NC
[[../img/archivero.jpg]]
...
\centering La unidad mínima de asignación dentro de un volumen es el
/bloque/.
#+latex: \begin{columns} \begin{column}{0.4\textwidth}
#+attr_latex: :width \textwidth
#+caption: \scriptsize Generada (perchance.org)
[[../img/cubo_de_legos.jpg]]
...
- El volumen es /descrito por el superbloque/
  - El superbloque /no contiene/ a los archivos, ni al directorio, ni
    estructuras que apunten hacia ellos
...
** Superbloque: ¿Qué hay en este dispositivo?
...
#+caption: \scriptsize Generada (perchance.org)
[[../img/varios_superbloques.jpg]]


** El superbloque en una unidad FAT
...
#+latex: \end{column} \begin{column}{0.3\textwidth}
#+attr_latex: :width \textwidth
#+caption: \scriptsize \href{https://foto.wuestenigel.com/foto/518125-518125-bunter-salat-mit-paprika-und-tomaten-auf-weissem-hintergrund}{Marko Verch}, CC BY
[[../img/ensalada.jpg]]
#+latex: \end{column} \end{columns}
...
- Estructura que relaciona a los archivos como son presentados al
  ...
  - Con las estructuras que los describen ante el sistema operativo (los
    /i-nodos/).
...
#+attr_latex: :width 0.4\textwidth
#+caption: \scriptsize \href{https://www.dreamstime.com/hard-disk-drive-magnifying-glass-information-search-diagnostics-restore-concept-vertical-image345267411}{Dreamstime}, PD
[[../img/buscar_en_disco.jpg]]
...
** Ejemplo de indirección multinivel \circulo{1}
...
** Ejemplo de indirección multinivel \circulo{2}
...
** Evitando o recuperando de estados inconsistentes
   Ha habido dos principales estrategias para asegurar que un volumen
   esté siempre consistente — O pueda, por lo menos, detectarlo y
   converger a un estado consistente:

   - Actualizaciones suaves
   - Sistemas de archivo con bitácora

   (...y las /actualizaciones suaves/ han sido prácticamente
   abandonadas :-( )
