...
** Nos /muerde/ el tiempo...
- Desafortunadamente, /mea culpa, mea culpa, mea máxima culpa/... No
  nos alcanzó el tiempo para desmenuzar en clase lo que esta
  abstracción significa
  - Su evolución
  - Sus interfaces
- Los invito fuertemente a revisar el material que debíamos haber
  cubierto
  - [[http://sistop.gwolf.org/html/06_sistemas_de_archivos.html][Secciones 1, 2 y 3 del capítulo 7, Sistemas de Archivos]]
  - [[http://sistop.gwolf.org/laminas/14-archivos-y-directorios.pdf][Presentación #14, Archivos y directorios]]
...
- Representa el estado de un bloque entero por cada bit
  ...
  - Y ha ido creciendo a una razón aceptable desde los /viejos
    tiempos/ (p. ej., 10KB para 40GB en sectores de 512 bytes, común
...
** FAT: La extensión VFAT
#+caption: Entradas de directorio representando archivos con y sin nombres largo bajo VFAT
#+attr_latex: width=\textwidth
