...
- 3. Administración de procesos :: La entidad principal con la que
     ...
     entre estas y sus /hermanos menores/ (los /hilos/), y los
...
- 4. Planificación de procesos :: Para que varios procesos coexistan
     ...
     operativo debe /multiplexar/ entre todos ellos es el tiempo de
     ...
     modelos de planificación de hilos y profundizar en su relación
...
- 5. Administración de memoria :: Los /programas/ sólo se vuelven
     procesos cuando se les asigna memoria: Cuando dejan de ser el
...
- 7. Sistemas de archivos :: Este capítulo presenta la contraparte
     ...
     archivos bastante viejo, pero aún en muy amplio uso en el cómputo
...
- A. Software libre y licenciamiento :: Estudiar sistemas operativos
     ...
     claramente ha cambiado al desarrollo del cómputo. Todos los
