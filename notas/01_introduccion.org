...
# "corre" tiene una acepción puerca en España y no se usa para esto
...
# Quité la repetición de "básicamente" -con base-, corrección de "corren"
...
#Cambié la conjugación, para hacerlo más impersonal y quité la repetición de "comprendan"
...
# aquí nosotros utilizamos "seguridad informática", suena muy raro "seguridad en cómputo"
...
# prefiero la palabra "administración" o "gestión" en lugar de manejo
...
# tipo y repetición de encontrar, legibilidad

cómputo: cuando en los '50 aparecieron los dispositivos
# mayúscula y forma de expresar décadas
...
# tambache es muy mejicana, aquí he sentido usar la palabra "sarta", 
# podría ser tanda también ...
...
# cambio para evitar ambiguedades
...
# normalización del formato de décadas
...
# corrección de tiempo (no se si es correcto, pero me resulta más legibile)
...
# mayúscula, mejora de la legibilidad
...
# cambié "cambió fuertemente" que ya se había usado un par de párrafos atrás
...
# corrección del tiempo de verbo
...
# correccion del tiempo de verbo
...
# me parecio muy confuso este parrafo
...
# cambié prácticamente que se repetía en la sig. oración
...
# quité mal comportado que me sonaba feo
...
# mejora de legibilidad (aunque no estoy seguro de respetar lo que se quería decir)
