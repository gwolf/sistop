...
#+attr_latex: width=0.7\textwidth
#+attr_html: height="206"
#+caption: Transición del flujo entre espacio usuario y espacio núcleo en una llamada al sistema (Imagen: /Operating system Concepts Essentials/; Silberschatz, Galvin, Gagne; p.22)
...
aparecieron emuladores que permitían ejecutar programas de los
distintos 
