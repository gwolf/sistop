...
(/Advanced Power Management/, Gestión Avanzada de la Energía). Pasado
cierto tiempo, fue reemplazado por
#+latex: \textsc{acpi}
...
#+latex: \textsc{apm}
#+html: <span class="smallcaps">apm</span>
los diferentes niveles de energía se implementaban en el /firmware/ de
la computadora o cada uno de sus dispositivos, en
#+latex: \textsc{acpi}
#+html: <span class="smallcaps">acpi</span>
