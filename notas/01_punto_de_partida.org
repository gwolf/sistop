...
(se verá en detalle en el capítulo \ref{PROC}).
...
Estos sistemas implementaron, colaborativamente y bajo un esquema de
desarrollo geográficamente distribuido,
...
- Windows Phone :: Microsoft ofrece una versión de su sistema
                   operativo, compatible en *api* con el Windows de
