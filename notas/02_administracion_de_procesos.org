...
ilusión de simultaneidad en la sección /[[./03_planificacion_de_procesos.org][Planificación de procesos]]/.
...
#+include: fig/jefe_trabajador.dot
     ...
     #+results:
     [[file:ltxpng/jefe_trabajador.png]]
     #+html: <p align="center">Patrón de hilos jefe/trabajador</p></div>
...
- Equipo de trabajo :: Al iniciar la porción multihilos del proceso,
     ...
     Sus principales diferencias con el patrón /jefe/trabajador/
     consisten en que el trabajo a realizar por cada uno de los hilos
     ...
     /eventos independientes/ (como en el caso anterior), sino que
...
#+include: fig/equipo_trab.dot
     ...
     #+results:
     [[file:ltxpng/equipo_trab.png]]
     #+html: <p align="center">Patrón de hilos <em>Equipo de trabajo</em></p></div>
...
#+include: fig/linea_ensamblado.dot
     ...
     #+results:
     [[file:ltxpng/linea_ensamblado.png]]
     #+html: <p align="center">Patrón de hilos <em>Línea de ensamblado</em></p></div>
...
#+attr_latex: width=0.7\textwidth
#+caption: Sincronización al intentar ejecutar concurrentemente una sección crítica (imagen: Prof. Samuel Oporto Díaz)
[[./img/secc_crit.png]]
...
#+include: fig/bloqueo_mutuo_simple.dot
...
#+include: fig/deadlocks_conserv_lib.dot

#+results:
[[file:ltxpng/deadlocks_conserv_lib.png]]
#+html: <p align="center">Espectro liberal—conservador de esquemas para evitar bloqueos</p></div>
...
declarara /una sóla vez/ qué recursos requeriría, pero posteriormente
...
#+include: fig/deteccion_bloqueos.dot

#+html: <p align="center">Detección de ciclos denotando bloqueos: Grafo de procesos y recursos en un momento dado</p></div>
...
empleada en todos los sistemas operativos de propósito general con
amplia utilización) es el llamado /algoritmo del avestruz/: Ignorar
...
clásicos de acceso rival y secuencial: Impresoras, cintas, terminales
seriales, etc. Sin embargo, también podemos ver como recursos a otras
entidades administradas por el sistema operativo — Como el espacio
disponible de memoria o el tiempo de procesamiento, o incluso
...
pero para muchas tareas, esto recae en las manos del programador.
...
e intentarlo e intentar nuevamente acceder al recurso un número dado
...
[[#det_y_rec_bloq][detección y recuperación de bloqueos]], aborten (y posiblemente
reinicien) la ejecución de aquellos procesos que no puedan
recuperarse.
