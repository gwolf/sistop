...
- Administrar el hardware
   manejador de interrupciones :: esto incluye el enmascarado y desenmascarado 
...
- Abstraer las interrupciones ::  el sistema operativo oculta a los programas de
                                  ...
                                  hardware ya que estas sondependientes de la
...
- Punto de entrada al sistema operativo :: como veremos más adelante en la 
                                Sección \ref{SYSCALLS} muchas procesadores y
                                sistemas operativos utilizan las interrupciones
                                como medio por la cual un proceso de usuario
...
- Atender excepciones y fallas :: como dijimos antes durante la ejecución de un
                                  ...
                                  Una excepción importante que debe tratar el 
                                  sistema operativo es la de fallo de paginación. 
                                  Veremos más sobre ella en el capítulo 4.




* Terminales
Las terminales son dispositivos electrónicos utilizados para ingresa datos
y emitir resultados dentro de un sistema de cómputo. Históricamente
...
fue dejada de lado ante la aparación sobre principios de los 1970 
...
en general son tratadas con secuencias de escape i.e. una serie
...
como Interfaz Gráfica de Usuario /Graphical User Interface (GUI)/
y a los sistemas de ventana.

En general los sistemas operativos modernos también incluyen
mecanismos para crear emular terminales de texto, ya sea
para tener múltiples instancias o para ejectuar una terminal de texto
dentro de una terminal gráfica.
...
dispositivo de almacemaineto con granularidad de bytes sino que
éstos se agrupan en /bloques/ de tamaño fijo.
...
mantener el reloj actualizado, implementar alarmas tanto para los
...
, como por ejemplo /Round Robin/, debe interrumpir al proceso
