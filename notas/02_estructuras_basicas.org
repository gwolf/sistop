...
- Atender las interrupciones y excepciones :: Como se verá más adelante, 
...
- Abstraer las interrupciones ::  El sistema operativo oculta a los programas de
                                  ...
                                  por ejemplo mensajes o señales o deteniendo el
                                  proceso que espera la acción relacionada con
                                  una interrupción y continuando su ejecución
                                  cuando ésta ocurre.
- Punto de entrada al sistema operativo :: Como se verá más adelante en la 
...
caché, estando algunos dentro del mismo CPU, por lo que típicamente se
encuentran sistemas híbridos, en los que los cachés de nivel
...
la familia .NET (ver sección \ref{VIRT_arq_inexistentes}), exponen un
API con mucha mayor distancia respecto al
...
=dtrace=, que al paso del tiempo ha sido /portada/[fn:: Se denomina
/portar/ el hacer las adecuaciones necesarias para que una herramienta
