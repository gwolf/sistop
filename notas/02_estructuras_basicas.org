...
- Atender excepciones y fallas :: Como se discutió antes, durante la
     ...
     proceso que la generó.  En el capítulo \ref{MEM} se verá con mucho
...
en la época definitoria de los conceptos que se están presentando,
...
transferencia de toda la información[fn:: uste modo de operación es
...
* Interfaz del Sistema Operativo -- lamadas al sistema
# <<HW_SYSCALLS>>
...
=dtrace=, y ha sido /portada/ a otros Unixes (*BSD, MacOS).
...
Las principales estructuras relacionadas que se encuentran en un
...
se la desarrollará particularmente en los capítulos \ref{PROC}
...
bien se sigue notando mejoría, esta apenas nos lleva a $T=350$,
con $g=1.4$.
