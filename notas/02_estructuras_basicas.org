...
#+caption: Velocidad y gestor de los principales niveles de memoria (Silberschatz, Galvin y Gagne 2010, p.28).
...
#+caption: Diagrama de la comunicación entre componentes de un equipo basado en /puente norte/ y /puente sur/ (imagen de la Wikipedia: /Puente Norte/).
...
#+label: HW_moore_orig
#+caption: La /Ley de Moore/: figura publicada en el artículo de 1965, prediciendo la miniaturización por 10 años.
[[./img/moore_orig.png]]

Esto cambió hacia el 2005. Tras más de 40 años de cumplirse, el modelo
conocido como la /Ley de Moore/ \parencite{Moore65}, enunciando que
cada dos años la
...
En 1967, Gene Amdahl presentó un artículo en el que indica los límites
máximos en que resultará la programación multiprocesada ante un
determinado programa \parencite{Amdahl1967}: parte de la observación
de que aproximadamente 40% del tiempo de ejecución de un programa se
dedicaba a la administración y el mantenimiento de los datos, esto es,
a tareas secuenciales.
...
#+caption: Ganancia máxima al paralelizar un programa, ilustrando los límites que impone la Ley de Amdahl.
...
Fue hasta 1988 que John Gustafson publicó una observación a esta ley
\parencite{Gustafson1988} que, si bien no la invalida, permite verla
bajo una luz completamente diferente y mucho más optimista. Gustafson
publicó este artículo corto tras haber obtenido ganancias superiores a
$1~020$ en una supercomputadora con $1~024$ procesadores: un
incremento casi perfectamente lineal al número de procesadores. Sí,
respondiendo a una carga altamente optimizada, pero no por eso menos
digna de análisis.
...
- El Módulo de Plataforma Confiable (*tpm* o /SecureBoot/) ::
  ...
  Como lectura para este tema resultan referencia obligada los
  diversos artículos en el /blog/ del desarrollador Matthew Garrett[fn::
  [[http://mjg59.dreamwidth.org/]]], particularmente entre septiembre del
  2011 y mayo del 2013. Garrett lidereó la alternativa que al día de
  hoy más se usa para poder iniciar Linux en un sistema bajo *tpm*;
  tiene /decenas/ de artículos desde muy descriptivos y generales
  hasta técnicos y específicos a puntos muy particulares.

  /Linux Weekly News/ publica otro artículo interesante al respecto
  \parencite{Securelevel}. Explica con bastante detalle cómo es que se
  plantea implementar el nivel de protección que busca ofrecer *tpm*
  desde un sistema Linux.

** Lecturas relacionadas
- \fullcite{Backus78}
- \fullcite{Moore65}
- \fullcite{IntelInterconnect}
- \fullcite{IntelDesktopBoard}
