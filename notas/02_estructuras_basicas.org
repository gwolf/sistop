...
dentro de cada /uno de los/ núcleos de cada uno de los CPUs. Las
arquitecturas tipo RISC sólo contemplan la ejecución de instrucciones
...
- Atender excepciones y fallas :: Como se discutió antes, durante la
     ...
     como por ejemplo, una división por cero. Desde el punto de
...
la computadora envía y recibe un flujo de caracteres desde y hacia el usuario.
...
pueden ser vistos como una región donde la computadora leee y escribe
...
almacenamiento byte por byte, sino que estos se agrupan en /bloques/
...
proceso requiere de alguna acción privilegiada, acede a ellas levantando
