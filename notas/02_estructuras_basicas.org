...
con una letra cada uno, así (en general) =C:= es el volúmen o partición
del disco principal, =A:= y =B:= se utilizan para discos
extraíbles.
...
/multiprogramación/, de la cual se hablará en la sección
