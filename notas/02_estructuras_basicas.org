...
principales computadoras de ocho bits) tenía un acumulador de ocho bits (*a*),
dos registros índice de ocho bits (*x* e *y*), un registro de estado del
procesador de ocho bits (*p*), un apuntador al /stack/ de ocho bits (*s*), y un
apuntador al programa de 16 bits (*pc*). El otro gran procesador de su
era, el Zilog Z80, tenía 14 registros (tres de ocho bits y el resto de 16),
