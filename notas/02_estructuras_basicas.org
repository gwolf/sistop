...
cargados en los registros. El estado del CPU en un momento dado está determinado
por el contenido de los registros. El contenido de la memoria, obviamente,
...
Las operaciones más complejas, como edición, borrado y movimientos
...
magnéticos[fn:: Veremos en la sección \ref{FS_FIS_estado_solido} detalles
...
memoria/), vemos cómo es que se efectúan dichas referencias.
...
# <<HW_SYSCALLS>>
De forma análoga a las interrupciones, podemos hablar
...
los detalles del sistea operativo. 
...
Probablemente el tema que abordaremos más recurrentemente a lo largo de este texto
