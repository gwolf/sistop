...
simultaneidad se abordarán en el capítulo \ref{PLAN}.
...
- Esto parece muy específico ::
  ...
  misma circunstancia podría darse en un sistema de reserva de vuelos
...
cuestión sea protegido por un mutex.
...
Otro mecanismo de prevención es la asignación /jerárquica/ de
