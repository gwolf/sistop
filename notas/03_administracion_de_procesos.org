...
- Espera activa :: La solución presentada mantiene todavía el problema
                   ...
                   problema. Veremos algunas de esas abstracciones más
                   adelante.
...
- /Rendezvous/ :: Así se denomina en francés (y ha sido adoptado al
                  ...
                  cálculos para mostrar. Se desea mostrar al usuario
...
**** Solución
  ...
  implementaciones, ya que encontraremos varios casos en que no es el
...
- Problema lectores-escritores :: Una estructura de datos puede ser
     ...
     algún proceso está escribiendo, se debe evitar que cualquier otro
...
(2008) para profundizar en este tema. En este libro, encontraremos
...
original de Djikstra (así como en los ejemplos que presentamos
...
*** Memoria transaccional
     ...
     las bases de datos, en que tras abrir una transacción, podemos
...
para que se produzca un bloqueo; su presencia puede llamar indicar una
...
sistema.
# Ojo: la ultima oracion no está clara
...
presentado.
# no me queda claro a que se refiere con proceso único
...
# no me queda claro "ya su utilizacion"
