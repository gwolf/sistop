...
en la competencia por recursos, a veces un programa requiere no pasar
por esa ilusión — Parte del desarrollo de un programa puede depender
...
sección \ref{peterson} la /Solución de Peterson/, un mecanismo que
permite estas interrupciones, aunque resta generalidad a la solución e
incurre en costos de tiempo de cómputo muy elevados], tenemos que
hacerlo a través de instrucciones de las que el planificador pueda
/asegurar/ su atomicidad.
