...
problemas que implican el acceso concurrente a una sección crítica.
Cabe destacar que para obtener una buena solución es necesario cumplir
con las siguientes condiciones:
- 1) :: No puede haber dos procesos en simultáneo en sus secciones
críticas.
- 2) :: No se puede suponer nada acerca de las velocidades relativas
del CPU.
- 3) :: Ningún proceso que se ejecute fuera de su sección crítica puede
detener a otro proceso.
- 4) :: Ningún proceso esperará infinitamente para entrar a su sección
crítica.

Se presentan a continuación los sucesivos /intentos/.
...
planteada por Peterson unos cuantos años más tarde, en 1981.
