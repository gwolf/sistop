...
book of semaphores]] de Allen Downey (2008).  En este libro (de libre
...
- Esto parece muy específico ::
  ...
  específica al planteamiento en cuestiónm es fácil ver que la misma
  circustancia podría darse en un sistema de reserva de vuelos
...
- ¿Pero no es muy poco probable? ::
  ...
  concurrencia sean muy difíciles de detectar y más aún de corregir. Es
...
- Espera activa :: La solución presentada mantiene todavía el problema
		   ...
		   Para mayores detalles acerca de las razones,
                   ...
                   sistemas operativos reales, referirse a [[http://www.cs.fsu.edu/~baker/devices/notes/spinlock.html][Spin Locks
                   & Other Forms of Mutual Exclusion]] (Theodore
                   P. Baker 2010)
...
de un candado explícito —se podría leer la línea cinco como /exclusión
...
de exclusión mutua abarca desde la línea cinco en que es invocada
...
- Ser completa :: Se debe analizar bien cuál es el área a
     ...
     interrumpiera entre las líneas siete y ocho, la condición del
...
requerir. Éstos son apartados para su uso exclusivo hasta que
...
el desarrollado por Habermann (Finkel, p. 136).
...
salir de ella. Esta podría ejecutarse ser una tarea
...
- /The little book of semaphores/
  #+latex: \otrorec{http://greenteapress.com/semaphores}
  #+html: <br/><a href="http://greenteapress.com/semaphores">http://greenteapress.com/semaphores</a><br/>
