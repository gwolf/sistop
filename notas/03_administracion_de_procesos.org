...
uno de los procesos actuales se almacena en una estructura llamada
...
- Estado de E/S :: Listado de dispositivos y archivos asignados que el
                   proceso tiene /abiertos/ para entrada y salida
                   (E/S) en un momento dado.
...
que ocurrirán/. Si bien dos procesos (o hilos) completamente
independientes entre sí ejecutándose simultáneamente son dos procesos
concurrentes, este apartado se ocupa principalmente de procesos cuya
...
entrar a determinada sección crítica, es posible emplear únicamente
las siguientes dos variables para implementar de forma segura una
...
La principal restricción de esta solución es que parte del supuesto de
que ambos procesos se irán alternando para entrar a la sección
crítica; si el ritmo al cual /i/ y /j/ buscan entrar a la sección
crítica difiere, uno de ellos perderá mucho tiempo esperando al otro.
