...
#+include: fig/planificador.ditaa
...
#+include: fig/planif_rr1.ditaa
#+html: <p align="center">Ronda (<em>Round Robin</em>)</p></div>
...
#+include: fig/planif_rr4.ditaa
#+html: <p align="center">Ronda (<em>Round Robin</em>), con <em>q=4</em></p></div>
...
#+include: fig/planif_fb_bas.ditaa
...
#+include: fig/planif_fb_exp.ditaa
...
#+include: fig/pipeline.ditaa
#+html: <p align="center">Descomposición de una instrucción en sus cinco pasos clásicos para organizarse en un <em>pipeline</em></p></div>
...
#+include: fig/hyperthread.ditaa
#+html: <p align="center">Alternando ciclos de cómputo y espera por memoria, un procesador que implementa hilos hardware (<em>hyperthreaded</em>) se presenta como dos procesadores</p></div>
