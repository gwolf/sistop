...
Un mecanismo que evitaría la necesidad de implementar esquemas de
balanceo puede ser el que existiera una sóla cola de procesos y que
los distintos procesadores fueran avanzando con ésta; un mecanismo
así, sin embargo, haría mucho más difícil mantener la afinidad a
cierto procesador y restaría flexibilidad al sistema completo, por lo
