...
¿cómo podemos determinar el número máximo?
...
presentamoss al inicio de esta sección, si tenemos 4 procesos que
...
memoria virtual, el uso total de memoria virtual sería de $V = 512 +
28 + 140 + 80 = 760$ páginas, esto es, el sistema tendría comprometido
a través de la memoria virtual un sobreuso cercano a 3:1 sobre la
memoria física. Cada proceso recibirá entonces $F_P =
\frac{V_P}{V} \times m$, donde $F_P$ indica el espacio de memoria
física que el proceso recibirá, $V_P$ la cantidad de memoria virtual
que está empleando, y $m$ la cantidad total de marcos de memoria
disponibles. De este modo, $P_1$ recibirá 173 marcos, $P_2$ 10, $P_3$
47 y $P_4$ 26, proporcionalmente a su uso de memoria virtual.
...
32KB (8 páginas), o que $P_1$ multiplicara por 4 su uso de memoria
virtual, ningún proceso debe tener asignado menos del mínimo
definido. Por otro lado, este esquema ignora por completo las
prioridades que hoy en día manejan todos los sistemas operativos; si
quisiéramos que las consideraran, podría incluirse como factor la
prioridad, multiplicando junto con $V_P$.
...
serie de fallas de página, a las que el sistema operativo responde
...
#+caption: Los picos y valles en la cantidad de fallos de página de un proceso ayudan a definir a su /conjunto activo/  (Silberschatz, p.349)
