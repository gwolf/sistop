...
algoritmos. Finkel simuló el comportamiento que estos algoritmos
...
desarrollo o máquina virtual (ver sección
\ref{VIRT_arq_inexistentes}) que emplee /hilos de usuario/
