...
En el desarrollo de sistemas multitarea, es decir, sistemas en los
cuales es posible ejecutar dos o más programas de forma concurrente, surgió la
necesidad de administrar de forma activa el espacio de memoria disponible. 
Esto conlleva que el sistema operativo debe encargarse de ubicarse a sí
mismo y a los programas en /el mismo espacio/ físico de memoria, y de
administrar el espacio usado y el espacio disponible para él y para los
...
Algunos de los primeros sistemas en manejar memoria paginada empleaban
un conjunto especial de registros para representar la tabla de
páginas. Esto era posible dado que sus registros eran de 16 bits, con
páginas de 8 *kb* ($2^{13}$). Esto significa que contaban con ocho páginas
posibles ($2^3$), por lo que resultaba sensato dedicar un registro a cada una.
...
multiprogramación. De este modo, si un proceso se ve obligado a esperar por 8
