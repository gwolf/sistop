...
$2^{12}), se tendrían 1.048.576 ($2^{20}$) páginas. Si cada entrada
...
#+label: MEM_expectativa_fallas_marcos
#+caption: Relación ideal entre el número de marcos y fallos de página
...
software /propietario/ (En la sección \ref{sec-8-1-3} se aborda
