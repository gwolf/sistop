...
- Espacio de /libres/ ::  Espacio de memoria que se emplea
     ...
     dinámica manual de la memoria/ (como C), esta área es la que se maneja a
...
inicio del proceso en memoria/ — Esto es, las direcciones son /resueltas/ o traducidas.
Existen diferentes estrategias de resolución, que se pueden clasificar en:
...
en que cada proceso está dividio en varios bloques (más pequeños que los segmentos) 
de tamaño fijo llamados /páginas/, dejando
...
Se debe considerar que existe una gran cantidad de /código durmiente o inalcanzable/: Código
...
prácticos podemos ignorar a $t_a$. Con los valores presentados, seleccionando
...
- Bit de referencia :: Esta es una aproximación bastante
     ...
     tengan un bit adicional, al que llamaremos /de referencia/ (bit de acceso). 
...
- Apuntador a la pila :: (/Stack pointer/, /SP/) Apunta al /final
     ...
     emplea el registro =ESP=;cuando se le pide al procesador que actúe sobre
