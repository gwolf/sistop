...
64 *kb* ($65~535$ bytes) a partir de la dirección $504~214$ (492
*kb*), el /registro base/ contendría $504~214$, y el /registro límite/
$65~535$. Si hubiera una instrucción por parte de dicho proceso que
solicitara una dirección menor a $504~214$ o mayor a $569~749$ (556
*kb*), la *mmu* lanzaría una excepción o /trampa/ interrumpiendo el
...
sostenida al disco de 50 *mb*/s, intercambiar un proceso al disco toma
...
páginas de 8 *kb* ($2^{13}$). Esto significa que en el sistema había
...
obligado a esperar por 8 ms a que se resuelva un fallo de página,
...
el texto de Luis La Red (pp. 559-569) se puede observar que en
...
conjunto de páginas a otro, o dicho de otro modo, que cambió elxs
...
ejecutable. Esto implica que /cada programa/ tiene su propia copia del
código de la biblioteca, lo cual puede causar un desperdicio de
memoria y disco si hay muchos programas que usan la misma versión.
