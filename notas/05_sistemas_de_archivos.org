...
identificados por un /nombre/. Hablaremos más adelante acerca de
las diferentes construcciones semánticas que pueden conformar a los
directorios.
...
- Abrir :: Solicita al sistema operativo verificar si tenemos el
           ...
           un disco de sólo lectura). Abrir un archivo es necesario
           para todas las siguientes operaciones.
...
- Leer :: Cuando indicamos al sistema que queremos leer de un archivo
          ...
          la última posición leída, para poder sencillamente continuar
          con la lectura.
...
- Modos de acceso :: Aunque un usuario tenga permisos de acceso a
     ...
     llevaría a un inconsistente. Por ejemplo, si dos procesos abren
...
* TODO Organización y acceso a archivos
* TODO Estructura de los directorios
* TODO Estructura de los sistemas de archivos
* TODO Métodos de asignación
* TODO Administración del espacio libre

* TODO Particularidades de medios: Cuando no es un disco
