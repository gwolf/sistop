...
#+include: fig/capas_acceso_a_discos.org
#+html: <p align="center">Capas de abstracción para implementar los sistemas de archivos</p></div>
...
#+include: fig/acceso_secuencial.ditaa
...
#+include: fig/acceso_aleatorio.ditaa
...
#+include: fig/acceso_relativo_a_indice.ditaa
...
#+include: fig/directorio_simple.dot
...
#+include: fig/directorio_arbol.dot
...
#+include: fig/directorio_DAG.dot
...
#+include: fig/directorio_DAG_completo.dot
...
#+include: fig/puntos_de_montaje.dot
...
#+include: fig/montaje_windows.dot
...
#+include: fig/entrada_directorio_fat.ditaa
...
#+include: fig/fs_asignacion_contigua.ditaa
...
#+include: fig/fs_asignacion_ligada.ditaa
...
#+include: fig/fs_asignacion_indexada.ditaa
...
#+include: fig/fs_apuntadores_indirectos.dot

#+results:
[[file:ltxpng/fs_apuntadores_indirectos.png]]
#+html: <p align="center">Estructura típica de un i-nodo en Unix, mostrando además el número de accesos a disco necesarios para llegar a cada cluster (con sólo tres cluster por lista)</p></div>
...
#+include: fig/inconsistencias_fat.dot
...
#+begin_src gnuplot :var data=mov_cabeza_por_algoritmo :exports results :file ltxpng/mov_cabeza_por_algoritmo.png
reset
...
#+include: fig/franjas_raid_0.ditaa
#+html: <p align="center">División de datos en <em>franjas</em></p></div>
...
#+include: fig/franjas_raid_5.ditaa
#+html: <p align="center">División de datos en <em>franjas</em>, con paridad, para RAID 5</p></div>
