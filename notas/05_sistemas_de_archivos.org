...
archivo — Si el bit 4 del byte 12 de una entrada de directorio está
encendido, los datos correspondientes al archivo serán interpretados
como una tabla de directorios.
...
** Particiones y volúmenes multi-disco
