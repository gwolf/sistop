...
- Metadatos externos :: El sistema de archivos HFS (/Hierarchical File
     System/, /Sistema de Archivos Jerárquico/) empleado por las Apple
     Macintosh desde 1984 separa en dos /divisiones/ (/forks/) la
     información de un archivo: Los datos que propiamente constituyen
     al archivo en cuestión son la /división de datos/ (/data fork/),
     y la información /acerca del archivo/ se guardan en una
     estructura independiente llamada /división de recursos/
     (/resource fork/).
