...
- Abrir :: Solicita al sistema operativo verificar si el archivo existe y
	   se cuenta con el
...
mismo cuidado que el de bloqueo por recursos que el que cubierto en
...
El concepto dominante en almacenaimiento hoy en día es el /directorios
