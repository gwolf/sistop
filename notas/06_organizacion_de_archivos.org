...
- Acceso secuencial :: Mantiene la semántica por medio de la cual
     ...
     \ref{DIR_operaciones_con_archivos} (/Operaciones con archivos/):
...
- Liga dura :: La entrada de un archivo en un directorio Unix es la
  ...
  2. No pueden hacerse ligas duras a directorios, sólo a archivos[fn::
     ...
     directorios (sección \ref{DIR_dir_traversal}).]
...
\ref{DIR_directorio_DAG} apegándonos más a la realidad: En los sistemas
...
Como podemos ver en la figura \ref{DIR_directorio_DAG_completo}, en
