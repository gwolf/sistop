...
- Leer :: Si se solicita al sistema la lectura de un archivo
          hacia determinado buffer, éste copia el siguiente /pedazo/
          de información. Este /pedazo/ podría ser una línea o
...
- Metadatos externos :: Los sistemas de archivos empleado por las
     ...
     una llamada /appDirectory/, para propósitos de esta
...
- Acceso relativo a índice :: En los últimos años se han popularizado
     ...
     acceso aleatorio sobre el índice, y el apuntador avanza a la
