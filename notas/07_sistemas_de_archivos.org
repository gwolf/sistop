...
Por ejemplo, en un sistema Linux, leer el archivo
=/proc/sys/vm/swappiness= dará (por omisión) un valor de 60. Escribir
el valor 100 a este archivo tendrá por resultado que el sistema sea
más agresivo con la paginación de memoria virtual (ver sección
\ref{MEM_virtual}) de lo que normalmente sería. Por otro lado,
escribir el valor 1 tendrá por efecto que el sistema operativo realice
la paginación prácticamente sólo si no tiene otra alternativa. Un
valor de 0 tendrá como efecto inmediato el deshabilitar la paginación
por completo.
