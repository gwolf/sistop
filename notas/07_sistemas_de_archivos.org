...
grupo *usenix*, T. J. Killian presentó el artículo "/Processes as
files/" \parencite{Killian84}. Killian implementó un sistema de
archivos virtual para ser montado en el directorio =/proc= del sistema
que, en vez de representar un mapa de bloques, presentaba una ventana
a la lista de procesos en ejecución en el sistema. El uso de =/proc=
fue incorporado a prácticamente todos los sistemas tipo Unix.
