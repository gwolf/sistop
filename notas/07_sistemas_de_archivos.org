...
si bien esto puede no parecer muy limitado, [[https://en.wikipedia.org/wiki/File_Allocation_Table#VFAT_long_file_names][ocupar cuatro entradas por
...
\ref{FS_entrada_directorio_fat}) está activado, la región de datos
correspondientes a dicho archivo será interpretada como un
subdirectorio.
