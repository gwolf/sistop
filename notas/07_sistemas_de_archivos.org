...
hacerlo a nivel bloque, y lleva típicamente a una optimización del
uso de espacio mucho mayor.
...
Server 2003, la funcionalidad de desduplicación existe directamente
para *ntfs*, pero su uso es poco frecuente.
