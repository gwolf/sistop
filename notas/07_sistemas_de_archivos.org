...
archivo[fn::
#+latex: \url{https://en.wikipedia.org/wiki/File_Allocation_Table#VFAT_long_file_names}
#+html: Ver Wikipedia: <a href="https://en.wikipedia.org/wiki/File_Allocation_Table#VFAT_long_file_names">File Allocation Table: Long file names</a>
]
cuando, empleando VFAT, se tiene un nombre medianamente largo reduce
...
#+caption: Entradas representando archivo con nombre largo bajo VFAT (Imagen: Peter Clark, ver /otros recursos/)
...
#+label: FS_tabla_fat
#+caption: Ejemplo de entradas en la tabla de asignación de archivos (Imagen: Peter Clark, ver /otros recursos/)
#+attr_latex: width=\textwidth
[[../img/tabla_fat.png]]
