...
la década de 1980 aparecieron diversas implementaciones de discos
*RAM*: Programas diseñados para tomar un espacio de memoria y darle la
semántica de un disco, permitiendo manipular su contenido como si
fuera un disco cualquiera. Esto es, presenta almacenamiento volátil,
...
En junio 1984, en el congreso de desarrolladores de sistemas Unix
*usenix*, T. J. Killian presentó el artículo [[http://lucasvr.gobolinux.org/etc/Killian84-Procfs-USENIX.pdf][Processes as
...
lo emplea el sistema principal que utilizan los *cd-rom*, el
