...
estructura formal ideal, una entidad almacenada en un dispositivo.
...
/discos/, y a lo largo de este capítulo, nos referiremos como /el
...
- Espacio de intercambio :: Como vimos en la sección \ref{MEM_acomodo_de_paginas}, la
...
que mencionamos en la sección \ref{DIR_grafo_dirigido} es que, en caso
...
probabilidad de colisión de 1 en $2^{256}$]; este mecanismo permite
...
de ZFS en la sección \ref{FS_FIS_zfs}], desarrollado por Sun Microsystems
...
\ref{DIR_archivos_estructurados}), gestionados por el sistema
...
relacionados. Sin embargo, en este tema, los /controladores
...
\ref{FS_FIS_estado_solido} abordaremos algunas de sus características), y
