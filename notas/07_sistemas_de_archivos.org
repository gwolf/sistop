...
superior a la de la asignación indexada.
...
Cualquier otro valor indica la ubicación del siguiente /cluster/ que
forma parte del archivo al cual pertenece el registro en cuestión.
