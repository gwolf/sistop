...
—convirtiendo a Linuxm al paso de los añosm de un sistema
...
conceptos. Las opciones[fn:: Parte del texto aquí presentado ha sido
tomado del asistente para la elección de licencias de Creative Commons
disponible en [[https://creativecommons.org/choose/?lang=es]]; dicho texto
está licenciado bajo un esquema *cc-by* (atribución) 4.0.]  de las
licencias *cc* son:
