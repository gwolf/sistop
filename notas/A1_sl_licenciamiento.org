...
- [[https://www.gnu.org/gnu/manifesto.html][The GNU Manifesto]] (Richard Stallman, 1985, Dr. Dobb's Journal)

- [[https://gnu.org/licenses/gpl.html][GNU General Public License version 3]] (Free Software
  Foundation, 2007)

- [[http://www.dwheeler.com/blog/2006/09/01/#gpl-bsd][GPL, BSD, and NetBSD - why the GPL rocketed Linux to success]] (David
  A. Wheeler, 2006)

- [[https://lwn.net/Articles/108250/][The Grumpy Editor's guide to free documentation licenses]] (Jonathan
  Corbet, 2004, Linux Weekly News)

- [[https://gnu.org/licenses/fdl.html][GNU Free Documentation License version 1.3]] (Free Software
  Foundation, 2008)

- [[http://seminario.edusol.info/][Construcción Colaborativa del Conocimiento]] (Gunnar Wolf, Alejandro
  Miranda, 2011)

- [[http://www.advogato.org/article/851.html][Towards a Standard of Freedom: Creative Commons and the Free
  Software Movement]] (Benjamin /Mako/ Hill, 2005)

- [[http://freedomdefined.org/Definition/Es][Obras culturales libres]] (Freedom Defined, 2006)
