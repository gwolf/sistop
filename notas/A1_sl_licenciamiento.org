...
M. Stallman [[https://www.gnu.org/gnu/gnu-history.html][anunció el nacimiento]] del Proyecto *gnu*,[fn:: Con el
particular sentido del humor que caracteriza a Stallman, las siglas
que eligió para el proyecto, *gnu*, son un /acrónimo recursivo/,
significan
...
publicó el [[https://www.gnu.org/gnu/manifesto.html][Manifiesto]] *gnu*, documento que hoy es lectura obligada
...
Mozilla/ (*mpl*, por sus siglas en inglés) o la /Licencia Común de
Distribución y Desarrollo/ (*cddl*, por sus siglas en inglés, creada
por Sun Microsystems), y su principal diferencia con las presentadas
por la *fsf* es que fueron propuestas no por grupos idealistas para el
desarrollo de software aún inexistente, sino que por empresas que
teníán ya un cuerpo de software, y encontraron este modelo como el más
/sustentable/ para continuar su desarrollo.
...
aficionado y con mediocre soporte a hardware en uno verdaderamente
sólido y universal.
...
proyecto /[[http://www.creativecommons.org/][Creative Commons]]/ (en adelante, *cc*). Citando del libro
/Construcción Colaborativa del Conocimiento/ (Wolf y Miranda, 2011):
...
- /The Evolution of the Unix Time-sharing System/
  #+latex: \otrorec{http://cm.bell-labs.com/cm/cs/who/dmr/hist.html}
  #+html: <br/><a href="http://cm.bell-labs.com/cm/cs/who/dmr/hist.html">http://cm.bell-labs.com/cm/cs/who/dmr/hist.html</a>
  Dennis Ritchie, Language Design and Programming Methodology
  conference; Sydney, Australia, 1979.
