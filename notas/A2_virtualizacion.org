...
implementación de /VMWare/.]  Si bien la virtualización permite
...
presentando su versión 1.x mediante un artículo en 2003 ([[http://www.cl.cam.ac.uk/netos/papers/2003-xensosp.pdf][Xen and the
Art of Virtualization]]). Este artículo presenta su experiencia
...
4. Identifique cuál de las siguientes afirmaciones describe la
   principal diferencia entre la virtualización asistida por hardware
