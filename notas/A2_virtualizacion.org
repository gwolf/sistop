...
década de los 1980 y 1990: si bien en general las computadoras de 8 bits
 no tenían
el poder de cómputo necesario para implementar la emulación de
arquitecturas similares, aparecieron tres líneas de computadoras
basadas en el CPU Motorola 68000 (Apple Macintosh, Atari ST y
Commodore Amiga) diferenciadas principalmente por sus /chipsets/. 
Para estas CPUs Surgieron emuladores que permitían ejecutar programas de una línea en la otra, prácticamente a la misma velocidad que en el sistema nativo.
...
software/. Actualmente la mayoría de las computadoras vendidas son
...
basadas en la misma arquitectura básica) se enfrentan a una 
