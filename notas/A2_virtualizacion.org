...
2. La emulación implica naturalmente el implementar un intérprete del
   código que fue originado para una arquitectura distinta. Este
   proceso necesariamente tiene un alto costo en tiempo de cómputo, y
   una infraestructura basada en emulación siempre será por lo menos
   un órden de magnitud más lenta que lo que resultaría de su
   ...
   de escritorio y las embebidas, y por el otro de la conveniencia de
   contar con código que pueda ser transportado fácilmente (/write
   once, run anywhere/).
...
4. La principal diferencia entre la virtualización asistida por
...
5. En el corazón de las arquitecturas de virtualización por hardware
...
- Sistemas operativos mínimos para la nube ::
  ...
  - ¿Qué significa esto para nuestra carrera/futuro profesional? ¿Hay
    espacio para desarrollar sistemas operativos novedosos, o
