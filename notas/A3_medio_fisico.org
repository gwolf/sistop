...
0.2 ms y 0.8 ms para ir de un cilindro al inmediato siguiente. Como
punto de comparación, el recorrido completo en una unidad de disco
flexible toma aproximadamente 100 ms, y el tiempo de un cilindro al
siguiente va entre 3 y 8 ms.
...
control del *cpu* al controlador de disco. El impacto de esto se
...
por lo menos una revolución adicional (8 ms con un disco de $7~200$ *rpm*)
...
Los esquemas *raid* vienen, sin embargo, de fines de la década de
1980, y si bien han cambiado el panorama del almacenamiento, en los
más de 20 años desde su aparición, han sido ya superados. El énfasis
en el estudio de *raid* (y no tanto en los desarrollos posteriores) se
justifica dada la limpieza conceptual que presentan, y dado que
esquemas posteriores incluso hacen referencia explícita en su
...
2. Realice un esquema de cómo se estructura cada bloque de información
   ...
   estos niveles, indique el impacto que su empleo tendría en cuanto a
...
- /OpenSolaris ZFS Deduplication: Everything You Need to Know/
  #+latex:  \otrorec{http://constantin.glez.de/blog/2010/03/opensolaris-zfs-deduplication-everything-you-need-know}
  #+html: <br/><a href="http://constantin.glez.de/blog/2010/03/opensolaris-zfs-deduplication-everything-you-need-know">http://constantin.glez.de/blog/2010/03/opensolaris-zfs-deduplication-everything-you-need-know</a><br/>
  Constantin Gonzalez (2010)

- /The Z File System (ZFS)/
  #+latex:  \otrorec{http://www.freebsd.org/doc/en_US.ISO8859-1/books/handbook/filesystems-zfs.html}
  #+html: <br/><a href="http://www.freebsd.org/doc/en_US.ISO8859-1/books/handbook/filesystems-zfs.html">http://www.freebsd.org/doc/en_US.ISO8859-1/books/handbook/filesystems-zfs.html</a><br/>
  FreeBSD Handbook
...
- /4K Sector Disk Drives: Transitioning to the Future with Advanced
  Format Technologies/
  #+latex:  \otrorec{http://storage.toshiba.com/docs/services-support-documents/toshiba_4kwhitepaper.pdf}
  #+html: <br/><a href="http://storage.toshiba.com/docs/services-support-documents/toshiba_4kwhitepaper.pdf">http://storage.toshiba.com/docs/services-support-documents/toshiba_4kwhitepaper.pdf</a><br/>
...
- /LogFS — Finally a scalable flash file system/
  #+latex:  \otrorec{http://www.informatik.uni-osnabrueck.de/papers_pdf/2005_07.pdf}
  #+html: <br/><a href="http://www.informatik.uni-osnabrueck.de/papers_pdf/2005_07.pdf">http://www.informatik.uni-osnabrueck.de/papers_pdf/2005_07.pdf</a><br/>
...
- /JFFS2, UBIFS, and the growth of flash storage/
  #+latex: \otrorec{http://lwn.net/Articles/528617/}
  #+html: <br/><a href="http://lwn.net/Articles/528617/">http://lwn.net/Articles/528617/</a><br/>
  Neil Brown (2012); Linux Weekly News

- /A case for Redundant Arrays of Inexpensive Disks/
  #+latex: \otrorec{http://www.cs.cmu.edu/~garth/RAIDpaper/Patterson88.pdf}
  #+html: <br/><a href="http://www.cs.cmu.edu/~garth/RAIDpaper/Patterson88.pdf">http://www.cs.cmu.edu/~garth/RAIDpaper/Patterson88.pdf</a><br/>
  Patterson, Gibson, Katz (1988); *acm sigmod*

- /Unidades de estado sólido. El reto de la computación forense en el
  mundo de los semiconductores/
  #+latex: \otrorec{http://insecurityit.blogspot.mx/2013/06/}
  #+html: <br/><a href="http://insecurityit.blogspot.mx/2013/06/">http://insecurityit.blogspot.mx/2013/06/</a><br/>
  Cano Martinez (2013); IT-Insecurity

- /Non-volatile memory based on the ferroelectric photovoltaic effect/
  #+latex: \otrorec{http://dx.doi.org/10.1038/ncomms2990}
  #+html: <br/><a href="http://dx.doi.org/10.1038/ncomms2990">http://dx.doi.org/10.1038/ncomms2990</a><br/>
  Guo, You, Zhow et. al. (2013); Nature Communications

- /eMMC/SSD File System Tuning Methodology/
  #+latex: \otrorec{http://elinux.org/images/b/b6/EMMC-SSD_File_System_Tuning_Methodology_v1.0.pdf}
  #+html: <br/><a href="http://elinux.org/images/b/b6/EMMC-SSD_File_System_Tuning_Methodology_v1.0.pdf">http://elinux.org/images/b/b6/EMMC-SSD_File_System_Tuning_Methodology_v1.0.pdf</a><br/>
