...
18:15 a 20:30 en el salón A-107.
...
2. *Administración de procesos*: El alumno identificará los tipos de
...
3. *Planificación de procesos*: El alumno explicará las diferentes
...
5. *Sistemas de archivos*: El alumno describirá las diferentes formas
...
6. *Sistemas de entrada/salida*: El alumno explicará las diversas
...
7. *Sistemas distribuídos*: El alumno explicará cómo se administran
...
8. *Seguridad y medidas de desempeño*: El alumno explicará cómo
