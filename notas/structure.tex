...
%\draw[anchor=west] (5cm,-9cm) node [rounded corners=25pt,fill=white,fill opacity=.6,text opacity=1,draw=Myblue,draw opacity=1,line width=2pt,inner sep=15pt]{\huge\sffamily\bfseries\textcolor{black}{\thechapter\ ---\ #1\vphantom{plPQq}\makebox[22cm]{}}};
\node[draw,text width=17cm] at (11.5cm,-3.5cm) [rounded corners=25pt,fill=white,fill opacity=.6,text opacity=1,draw=Myblue,draw opacity=1,line width=2pt,inner sep=15pt] {\huge\sffamily\bfseries\textcolor{black}{\thechapter\ ---\ #1\vphantom{plPQq}\makebox[12cm]{}}};
\end{tikzpicture}};
\end{tikzpicture}}\par\vspace*{130\p@}
\fi
\fi
}
...
\draw[anchor=west] (5cm,-5cm) node [rounded corners=25pt,fill=white,opacity=.7,inner sep=15.5pt]{\huge\sffamily\bfseries\textcolor{black}{\vphantom{plPQq}\makebox[22cm]{}}};
\draw[anchor=west] (5cm,-5cm) node [rounded corners=25pt,draw=Myblue,line width=2pt,inner sep=15pt]{\huge\sffamily\bfseries\textcolor{black}{#1\vphantom{plPQq}\makebox[22cm]{}}};
\end{tikzpicture}};
\end{tikzpicture}}\par\vspace*{130\p@}
\fi
\fi
